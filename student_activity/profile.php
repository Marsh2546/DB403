         ...
         <label for="profile-image" class="mb-3">
           <div id="image">
             ...
             if($student['image']){
               ...
               echo '<span class="mt-5 material-symbols-outlined" style="font-size:230px;">account_circle</span>';
             }
             ?>
           </div>
...
?>
    ...
    <script>
      ...
      image.innerHTML = '<img class="rounded-circle mt-5" style="height:42px;">';
